...
def example_usage(config_path: str, input_path_catalogue: str, output_path_catalogue: str, 
                  log_level: str = "INFO", n_jobs: int = 8, force: bool = False):
...
def main():
    ...
    parser.add_argument('--input_path_catalogue', required=True,
                        help='Path to input catalogue file (.parquet or .pkl)')
    parser.add_argument('--output_path_catalogue', required=True,
